...
class ImageViewer(QMainWindow):
    ...
    def save_(self):
        ...
        fileName, _ = QFileDialog.getSaveFileName(self,"Save Files",QDir.currentPath(),"JPG Files (*.jpg)", options=options)
        if fileName:
            print(fileName)
    ...
    def about(self):
        QMessageBox.about(self, "About Image Editor",
                "<p>The <b>Image Editor</b> is a demo application "
                "for our C++ Image Layer Management Library."
